...
public class AdapterCart1 extends RecyclerView.Adapter<AdapterCart1.modelViewHolder> {
    private Context context;
    private List<ModelItem> listitem;
    private OnCartItemClickListener onCartClickListener;

    public AdapterCart1(Context context, List<ModelItem> listitem, OnCartItemClickListener onCategoryClickListener) {
    ...
    public modelViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.recycler_cart1, parent, false);
